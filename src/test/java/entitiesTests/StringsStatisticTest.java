...
public class StringsStatisticsTest {
    private static final StringsStatistic STRINGS_STATISTICS = new StringsStatistic();
    private static final StringsStatistic STRINGS_FULL_STATISTICS = new StringsStatistic();
